...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-06-30 08:10:48
...
(174, 'Student', 'admin_url', 'student/classroom/list', NULL, '班级列表', 1, ''),
(175, 'Student', 'admin_url', 'student/manage/default', NULL, '学生排管理', 1, '');
...
CREATE TABLE `cmf_classrooms` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `cmf_classrooms`
--

INSERT INTO `cmf_classrooms` (`id`, `name`) VALUES
(1, '初中'),
(2, '高中'),
(3, '小学4-5'),
(4, '小学2-3');
...
--
-- 表的结构 `cmf_exam_result`
--

CREATE TABLE `cmf_exam_result` (
  `id` int(11) NOT NULL,
...
--
-- 转存表中的数据 `cmf_exam_result`
--

INSERT INTO `cmf_exam_result` (`id`, `user`, `p_id`, `ans`) VALUES
(1, 0, 0, ''),
(2, 0, 0, ''),
(3, 1, 0, ''),
(4, 1, 0, ''),
...
INSERT INTO `cmf_lessons` (`id`, `name`, `description`) VALUES
(1, 'VB语言基础', 'VB语言基础'),
(2, '算法的程序实现', '算法的程序实现');
...
(187, 0, 'Student', 'Manage', 'default', '', 0, 1, '学生排管理', 'group', '', 0),
(188, 187, 'Student', 'Manage', 'chuqin', '', 1, 1, '出勤', '', '', 0),
(189, 187, 'Student', 'Teacher', 'index', '', 1, 1, '服事者管理', '', '', 0),
(190, 187, 'Student', 'Student', 'index', '', 1, 1, '学生管理', '', '', 0),
(191, 187, 'Student', 'Classroom', 'index', '', 1, 1, '班级管理', '', '', 0),
(192, 187, 'Student', 'Manage', 'meeting', '', 1, 1, '聚会管理', '', '', 0),
(193, 187, 'Student', 'Manage', 'news', '', 1, 1, '新闻通知管理', '', '', 0),
(194, 187, 'Student', 'Report', 'chuqin', '', 1, 1, '出勤报表', '', '', 0),
(195, 197, 'Student', 'Semester', 'index', '', 1, 1, '学期列表', '', '', 0),
(196, 191, 'Student', 'Classroom', 'students', '', 1, 1, '班级名单', '', '', 0),
(197, 187, 'Student', 'Semester', 'index', '', 1, 1, '学期管理', '', '', 0);
...
(6, 'site_options', '            {\n            		"site_name":"GFZX信息技术教学管理系统",\n            		"site_host":"http://localhost/Thinkexam/",\n            		"site_root":"",\n            		"site_icp":"",\n            		"site_admin_email":"playoffs2005@163.com",\n            		"site_tongji":"",\n            		"site_copyright":"",\n            		"site_seo_title":"GFZX信息技术教学管理系统",\n            		"site_seo_keywords":"GFZX信息技术教学管理系统",\n            		"site_seo_description":"GFZX信息技术教学管理系统"\n        }', 1);
...
CREATE TABLE `cmf_semesters` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL COMMENT '学期名称',
  `start` date NOT NULL COMMENT '学期开始时间',
  `end` date NOT NULL COMMENT '学期结束时间',
  `current` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否当前学期'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='学期';

--
-- 转存表中的数据 `cmf_semesters`
--

INSERT INTO `cmf_semesters` (`id`, `name`, `start`, `end`, `current`) VALUES
(7, '2017年春季', '2017-01-05', '0000-00-00', 0),
(8, '2017年秋季', '2017-09-01', '0000-00-00', 0);
...
(1, 'admin', '###fb47a058ee7c56668e773bba98fec417', 'admin', 'playoffs2005@163.com', '', NULL, 0, '2000-01-01', NULL, '0.0.0.0', '2017-06-30 13:56:03', '2017-06-21 09:11:57', '', 1, 0, 1, 0, ''),
(2, 'test', '###6baff67a55e03071f87620ef5289db4f', '', 'df@sina.com', '', NULL, 0, '2000-01-01', NULL, '0.0.0.0', '2017-06-21 12:23:33', '2017-06-21 09:41:41', '', 1, 0, 1, 0, ''),
(3, 'fdshak_sina_com', '###fb47a058ee7c56668e773bba98fec417', 'fdshak_sina_com', 'fdshak@sina.com', '', NULL, 0, '2000-01-01', NULL, '0.0.0.0', '2017-06-26 14:54:41', '2017-06-26 14:54:41', '', 1, 0, 2, 0, '');
...
--
-- Indexes for table `cmf_classrooms`
--
ALTER TABLE `cmf_classrooms`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cmf_exam_result`
--
ALTER TABLE `cmf_exam_result`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cmf_lessons`
--
ALTER TABLE `cmf_lessons`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cmf_semesters`
--
ALTER TABLE `cmf_semesters`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cmf_students`
--
ALTER TABLE `cmf_students`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用表AUTO_INCREMENT `cmf_classrooms`
--
ALTER TABLE `cmf_classrooms`
...
--
-- 使用表AUTO_INCREMENT `cmf_exam_result`
--
ALTER TABLE `cmf_exam_result`
...
--
ALTER TABLE `cmf_menu`
  MODIFY `id` smallint(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=198;
--
...
--
-- 使用表AUTO_INCREMENT `cmf_semesters`
--
ALTER TABLE `cmf_semesters`
...
--
-- 使用表AUTO_INCREMENT `cmf_students`
--
ALTER TABLE `cmf_students`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
